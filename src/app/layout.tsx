...
export const metadata: Metadata = {
  title: "Wdebild – Award-Winning Creative Web Agency",  description: "Transforming ideas into digital excellence. We deliver creative web design, branding, and digital solutions for innovative brands worldwide.",  keywords: "creative agency, web design, branding, digital solutions, UI/UX design",  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Wdebild – Creative Web Agency",    description: "Transforming ideas into digital excellence with strategic design and development.",    siteName: "Wdebild",    type: "website"
  },
  twitter: {
    card: "summary_large_image",    title: "Wdebild – Creative Web Agency",    description: "Award-winning creative solutions for innovative brands"
  },
};
  ...
  const makeEditable = (element, clickEvent) => {
    ...
    if (clickEvent && element.childNodes.length > 0) {
      try {
        ...
        console.warn('[Wdebild] Could not set caret position:', e);
      }
    }
  };
  ...
  const handleMessage = (e) => {
        ...
        if (savedChanges) {
          ...
          changes.forEach(change => {
            try {
              ...
              console.warn('[Wdebild] Failed to revert change:', err);
            }
          });
        }
        clearLocalChanges();
      } catch (error) {
        console.error('[Wdebild] Failed to cancel changes:', error);
      }
      return;
    }
      ...
      try {
        ...
        if (selectedElement && isTextElement(selectedElement)) {
          ...
          try {
            ...
            console.warn('[Wdebild] Invalid selector:', selector);
          }
        }
    ...
    if (e.data.type === 'webild-update-button') {
      ...
      try {
        ...
        console.error('[Wdebild] Invalid selector for button update:', selector, error);
      }
      return;
    }
