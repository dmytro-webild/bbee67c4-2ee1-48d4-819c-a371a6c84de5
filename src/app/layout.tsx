...
export const metadata: Metadata = {
  title: "Webild – Award-Winning Creative Web Agency",  description: "Transforming ideas into digital excellence. We deliver creative web design, branding, and digital solutions for innovative brands worldwide.",  keywords: "creative agency, web design, branding, digital solutions, UI/UX design",  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
